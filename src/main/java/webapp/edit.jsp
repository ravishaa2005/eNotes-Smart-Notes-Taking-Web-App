...
if (user1 == null) {
    ...
    session.setAttribute("login-error", "Please login yourself inorder to add more notes");
    return;
}
%>
...
<head>
    ...
    <!-- Include the additional font styles -->
    <style>
        @import url('https://fonts.googleapis.com/css2?family=Times+New+Roman&family=Calibri&family=Georgia&family=Cambria&family=Verdana&display=swap');
        ...
        .ql-toolbar {
            ...
            z-index: 50; /* Ensure toolbar is above other elements */
        }
        ...
        /* Additional styles for custom font support */
        ...
        /* Make content placeholder white */
...
<body class="d-flex flex-column min-vh-100 edit-notes-page">
    <%
            ...
            <div class="row justify-content-center">
                <div class="col-lg-10">
                    <div class="text-center mb-4">
                        <h1 class="page-title">Edit Your Note</h1>
                    </div>
                    ...
                    <div class="note-container">
                        <div class="note-card">
                            ...
                            <div class="notebook-header">
                                ...
                                <div class="form-group mb-0">
                                    <div class="input-wrapper">
                                        <input type="text" class="title-input" id="title" value="<%=p.getTitle()%>" 
                            ...
                            <div class="notebook-body">
                                <form id="noteForm" action="NoteEditServlet" method="post" onsubmit="return prepareFormSubmission()">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="quill-wrapper">
                                            <div id="editor"></div>
                                            <div class="resize-handle" id="quill-resizer" title="Drag to resize editor"></div>
                                        </div>
                                    ...
                                    <div class="btn-container">
                                        <button type="submit" class="btn-update">
                                            <i class="fa fa-refresh"></i>Update Note
                                        </button>
                                    </div>
                                </form>
                            </div>
    ...
    <script>
        ...
        let originalContent = `<%= p.getContent().replace("\\", "\\\\").replace("'", "\\'").replace("\"", "\\\"").replace("\r", "\\r").replace("\n", "\\n") %>`;
